...
public class PutTripByIdRequest {
    ...
    public Integer getPricePerAdult() { return pricePerAdult; }
    public void setPricePerAdult(Integer pricePerAdult) { this.pricePerAdult = pricePerAdult; }

    public Integer getPricePerKid() { return pricePerKid; }
    public void setPricePerKid(Integer pricePerKid) { this.pricePerKid = pricePerKid; }
